...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/markdown-viewer/sw.js, scope=/markdown-viewer/）。
    // scope がツールの全 locale ページ（/markdown-viewer/, /markdown-viewer/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/markdown-viewer/sw.js', {
