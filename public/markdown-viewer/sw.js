...
const RUNTIME_CACHE = 'markdown-viewer-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/markdown-viewer/',
  '/markdown-viewer/manifest.json',
  '/markdown-viewer/icon-192.png',
  '/markdown-viewer/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/markdown-viewer/manifest.json';
}
